...
export const metadata: Metadata = {
  title: 'GDPR & Privacy Rights — ListOps',
  description: 'Your rights under GDPR and how ListOps handles personal data.',
}
  ...
  return (
    <div style={{ fontFamily: 'system-ui, sans-serif', background: '#f8fafc', minHeight: '100vh' }}>
      ...
      <div style={{ maxWidth: 760, margin: '0 auto', padding: '56px 40px' }}>
        {[
          { title: 'Right to Access', body: 'You have the right to request a copy of all personal data we hold about you. This includes your account information, usage history, and any content generated using your data. To request a data export, email us at privacy@listops.io.' },
          ...
          { title: 'Right to Data Portability', body: 'You have the right to receive your data in a structured, machine-readable format (JSON or CSV). Contact us at privacy@listops.io to request a portable data export.' },
        ...
        <div style={{ background: '#fefce8', border: '1px solid #fde68a', borderRadius: 16, padding: '28px 32px', marginTop: 8, marginBottom: 40 }}>
          ...
          <p style={{ fontSize: 15, color: '#78350f', lineHeight: 1.7, margin: 0 }}>
            Email <a href="mailto:privacy@listops.io" style={{ color: '#d97706', fontWeight: 600 }}>privacy@listops.io</a> with your request. We will respond within 30 days. You also have the right to lodge a complaint with your local data protection authority.
          </p>
        </div>
