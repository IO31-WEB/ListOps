...
export default async function FlyerPage({
  ...
  return (
    <>
      ...
      <div className="flyer-wrap" style={{ paddingTop: 64, paddingBottom: 48 }}>

        {/* ══ CLASSIC ═══════════════════════════════════════════ */}
        {template === 'classic' && (
          <div style={{ width: '8.5in', minHeight: '11in', margin: '0 auto', background: 'white', boxShadow: '0 8px 48px rgba(0,0,0,0.22)', display: 'flex', flexDirection: 'column', overflow: 'hidden' }}>
        ...
        {/* ══ LUXURY ════════════════════════════════════════════ */}
        {template === 'luxury' && (
          <div style={{ width: '8.5in', minHeight: '11in', margin: '0 auto', background: '#0a1628', boxShadow: '0 8px 48px rgba(0,0,0,0.5)', display: 'flex', flexDirection: 'column', overflow: 'hidden' }}>
        ...
        {/* ══ MODERN ════════════════════════════════════════════ */}
        {template === 'modern' && (
          <div style={{ width: '8.5in', minHeight: '11in', margin: '0 auto', background: 'white', boxShadow: '0 8px 48px rgba(0,0,0,0.22)', display: 'flex', overflow: 'hidden' }}>
